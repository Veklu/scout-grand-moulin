...
<div class="page-hero"><h1>Nos unités</h1><p>Quatre branches adaptées à chaque étape du développement des jeunes.</p></div>
<section><div class="container"><div style="display:grid;gap:32px">
<div class="card" style="display:grid;grid-template-columns:120px 1fr;gap:32px;align-items:center;border-left:5px solid #d4a017"><div style="text-align:center"><img src="https://scoutsducanada.ca/content/uploads/2023/12/20230109_-_Badge_castor_final.png" alt="Badge Castors — Scouts du Canada" style="width:90px;height:90px"></div><div><h2 style="font-size:1.3rem;color:var(--scout-green);margin-bottom:4px">Castors</h2><p style="color:#d4a017;font-weight:600;font-size:0.88rem;margin-bottom:12px">7 — 8 ans · Vendredi 18h45 à 20h45</p><p style="font-size:0.9rem;color:var(--text-soft);margin-bottom:12px">Les Castors découvrent le scoutisme par le jeu, les activités en nature et les travaux manuels. Ils apprennent à vivre en petit groupe, à développer leur curiosité et à respecter leur environnement.</p><p style="font-size:0.82rem;color:var(--text-muted)">📍 <a href="https://maps.app.goo.gl/j4ui35T8yks326Ka6" target="_blank">École Les Mésanges</a> · Animatrice : Mélanie Bizier</p></div></div>
<div class="card" style="display:grid;grid-template-columns:120px 1fr;gap:32px;align-items:center;border-left:5px solid #007748"><div style="text-align:center"><img src="https://scoutsducanada.ca/content/uploads/2023/06/badge_louveteau.png" alt="Badge Louveteaux — Scouts du Canada" style="width:90px;height:90px"></div><div><h2 style="font-size:1.3rem;color:var(--scout-green);margin-bottom:4px">Louveteaux</h2><p style="color:#007748;font-weight:600;font-size:0.88rem;margin-bottom:12px">9 — 11 ans · Mardi 18h45 à 20h45</p><p style="font-size:0.9rem;color:var(--text-soft);margin-bottom:12px">Les Louveteaux vivent des aventures en « meute ». Inspirés du Livre de la Jungle, ils développent leur autonomie, leurs habiletés et leur sens de la communauté.</p><p style="font-size:0.82rem;color:var(--text-muted)">📍 <a href="https://maps.app.goo.gl/j4ui35T8yks326Ka6" target="_blank">École Les Mésanges</a> · Animateur : Steve Kimmell</p></div></div>
<div class="card" style="display:grid;grid-template-columns:120px 1fr;gap:32px;align-items:center;border-left:5px solid #0065cc"><div style="text-align:center"><img src="https://scoutsducanada.ca/content/uploads/2023/08/badge_eclaireur.png" alt="Badge Éclaireurs — Scouts du Canada" style="width:90px;height:90px"></div><div><h2 style="font-size:1.3rem;color:var(--scout-green);margin-bottom:4px">Éclaireurs</h2><p style="color:#0065cc;font-weight:600;font-size:0.88rem;margin-bottom:12px">12 — 14 ans · Dimanche 18h00 à 21h00</p><p style="font-size:0.9rem;color:var(--text-soft);margin-bottom:12px">Les Éclaireurs travaillent en patrouilles autonomes. Ils planifient et réalisent des projets, développent leur leadership et vivent des défis de plein air plus ambitieux.</p><p style="font-size:0.82rem;color:var(--text-muted)">📍 <a href="https://maps.app.goo.gl/t1GRBt7Q4ZBuLd5x8" target="_blank">Local des Lions de Deux-Montagnes</a> · Animateur : Jonathan Perreault · 438-888-5822</p></div></div>
<div class="card" style="display:grid;grid-template-columns:120px 1fr;gap:32px;align-items:center;border-left:5px solid #c0392b"><div style="text-align:center"><img src="https://scoutsducanada.ca/content/uploads/2023/08/badge_pionnier.png" alt="Badge Pionniers — Scouts du Canada" style="width:90px;height:90px"></div><div><h2 style="font-size:1.3rem;color:var(--scout-green);margin-bottom:4px">Pionniers</h2><p style="color:#c0392b;font-weight:600;font-size:0.88rem;margin-bottom:12px">14 — 17 ans · Horaire à déterminer</p><p style="font-size:0.9rem;color:var(--text-soft);margin-bottom:12px">Les Pionniers sont les aînés du groupe. Ils vivent le scoutisme avec une grande autonomie : engagement communautaire, expéditions et projets de service.</p><p style="font-size:0.82rem;color:var(--text-muted)">Animatrice : Jennyfer Savard · ✉️ <a href="/cdn-cgi/l/email-protection#d1b8bfb7be91e4b4a2b2bea4a5b6a3b0bfb5bcbea4bdb8bfffbea3b6"><span class="__cf_email__" data-cfemail="fa93949c95bacf9f8999958f8e9d889b949e97958f969394d495889d">[email&#160;protected]</span></a></p></div></div>
</div></div></section>
